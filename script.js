(function () {
  ...
  function toggleAutoplay() {
    ...
    try { localStorage.setItem('mv_autoplay', _0xf0228b0a ? '1' : '0'); } catch {}
    _0xd1ee98e5();
    if (_0xf0228b0a) { _0xb9a49dc5(); _0x79ad8ff4(); } else { _0x0b46bbed(); }
  }

  function _0xd1ee98e5() {
    const _0x484b1794 = _0x8cbf6036("_ce2e4b410"), label = _0x8cbf6036("_cba25bc1f");
  ...
  function _0x54637bbb() {
    ...
    const _0x92dc95d8 = _0xb1a51adb.map(c => {
      ...
      return new Promise(resolve => {
        ...
        const _0x5c46e603 = () => { iframe._mvReady = true; resolve(); };
        iframe.onload = _0x5c46e603;
        const _0x6fa08542 = setTimeout(_0x5c46e603, _0x8bce8879);
        iframe.onload = () => { clearTimeout(_0x6fa08542); iframe._mvReady = true; resolve(); };
  ...
  // Session Extension via Supabase (Dulu Fake Session)
  async function _0xd9f6e27f() {
    const { data: { session } } = await _0xb6b66b5e.auth.getSession();
    if (!session) closeAdminPanel();
  }

  // Periodic Check dengan Supabase
  setInterval(async () => {
    if (_0x8cbf6036("_c5f03bd80")?.classList.contains('open')) {
        const { data: { session } } = await _0xb6b66b5e.auth.getSession();
        if (!session) {
  ...
  async function closeAdminPanel() {
    ...
    await _0xb6b66b5e.auth.signOut();
  }
  ...
  async function checkPw() {
    const _0x081d9df6 = 5, _0xf2422a5c = ((15 * 60) * 1000), now = Date.now();
    const _0x82a3d2f1 = _0x809cca86('bG9ja291dA=='), _0xdd3f5b5a = _0x809cca86('YXR0ZW1wdHM=');
    try {
    ...
    const email = _0x8cbf6036("_c5daa9f69").value.trim(), _0x5f9799ff = _0x8cbf6036("_c5e9ad1ef").value;
    ...
    btn.disabled = true;
    try {
      // Validasi langsung ke server Supabase!
      const { data, error } = await _0xb6b66b5e.auth.signInWithPassword({ email, password: _0x5f9799ff });
      ...
      let _0xd51d12ae = 0;
      try { _0xd51d12ae = parseInt((sessionStorage.getItem(_0xdd3f5b5a) || '0')); } catch (e) {}
      _0xd51d12ae++;
      sessionStorage.setItem(_0xdd3f5b5a, _0xd51d12ae);
      const _0xd659f6b8 = (_0x081d9df6 - _0xd51d12ae);
      if ((_0xd51d12ae >= _0x081d9df6)) {
        sessionStorage.setItem(_0x82a3d2f1, JSON.stringify({ until: (now + _0xf2422a5c) }));
        sessionStorage.removeItem(_0xdd3f5b5a);
        _0x8cbf6036("_c0481e632").style.display = 'block';
  ...
  function _0x65b812cd(_0xf9369494, text) {
    const _0xc8e28ca8 = _0x8cbf6036("_c7cff5314"), _0xe0cc05a1 = _0x8cbf6036("_c56527b1b");
  ...
  async function _0x71ef0847() {
    const { data, error } = await _0xb6b66b5e.from('mv_works').select('*').order('sort_order').order('created_at');
    if (error) { console.error(error); return; }
    _0xa18d6424 = (data || []);
    _0xacf50601(true); _0x78c09654(); _0x1a38ce4d(); _0xbc6edc7e();
    if (_0x8cbf6036('tab-list')?.classList.contains("_c599f219d")) _0x14f8e1ec();
  }

  async function _0x613ca34b() {
    const { data } = await _0xb6b66b5e.from('mv_site').select('data').eq('id', 1).single();
    if (data?.data) {
      _0x84479b26 = data.data;
      if (_0x84479b26.logoData) {
        await new Promise(resolve => {
          const _0xf631c5cc = new Image();
          _0xf631c5cc.onload = resolve; _0xf631c5cc.onerror = resolve; _0xf631c5cc.src = _0x84479b26.logoData;
        });
      }
      _0x82d5aeb5(); _0x1a38ce4d();
    }
  }

  function _0x8cbf6036(id) { return document.getElementById(id); }
  function _0x343b389d(id, v) { if ((v && _0x8cbf6036(id))) _0x8cbf6036(id).textContent = v; }
  function _0x676c77bf(s) { return String((s || '')).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'); }
  ...
  function _0xe90d247c(_0xa58fecf2, type = '') {
    ...
    t.textContent = _0xa58fecf2; t.className = `toast ${type} show`;
    clearTimeout(_0x35521202);
    _0x35521202 = setTimeout(() => t.classList.remove('show'), 3200);
  }

  function _0xe3297f5e(id) { const _0xac4acbd5 = (_0x8cbf6036(id).value || ''); return _0xac4acbd5.split(',').map(t => t.trim()).filter(Boolean); }
  function _0x25d824d5(id, _0x5ec253ae) { _0x8cbf6036(id).value = _0x5ec253ae.join(', '); }

  function togglePresetTag(_0xccb9b76e, _0x10c42d05, btn) {
    _0xd9f6e27f(); // Validasi session sblm ganti tag
    let tags = _0xe3297f5e(_0xccb9b76e);
    if (tags.includes(_0x10c42d05)) {
      tags = tags.filter(t => (t !== _0x10c42d05)); btn.classList.remove("_c599f219d");
    } else {
      tags.push(_0x10c42d05); btn.classList.add("_c599f219d");
    }
    _0x25d824d5(_0xccb9b76e, tags);
  }

  function syncPresetHighlight(inputId, _0x981a5888) {
    const tags = _0xe3297f5e(inputId), _0x7eeee7eb = _0x8cbf6036(_0x981a5888);
  ...
  function _0xce9b6a50(id) { return `https://img.youtube.com/vi/${id}/hqdefault.jpg`; }
  function _0x4d6ca5f9(id) { return `https://img.youtube.com/vi/${id}/hqdefault.jpg`; }
  ...
  function _0xbc6edc7e() {
    ...
    const _0x4882201b = (arr, min) => { let r = [...arr]; while ((r.length < min)) r = [...r, ...arr]; return r; };
    const _0x38312d13 = [{ id: "_cc14c3aa2", items: _0x4882201b(_0xf951f20f, 20), dir: 'left', speed: 60 }, { id: "_cdca16275", items: _0x4882201b([..._0xf951f20f].reverse(), 20), dir: 'right', speed: 75 }, { id: "_caea47b65", items: _0x4882201b(_0xf951f20f.slice(Math.floor((_0xf951f20f.length / 2))).concat(_0xf951f20f.slice(0, Math.floor((_0xf951f20f.length / 2)))), 20), dir: 'left', speed: 50 }];
    _0x38312d13.forEach(({ id, items, dir, speed }) => {
      ...
      requestAnimationFrame(() => {
        ...
        if ((dir === 'right')) _0x7045cc01.style.animationName = 'slideRight';
      });
    });
    setTimeout(() => { const wrap = _0x8cbf6036("_c32f09ea4"); if (wrap) wrap.classList.add('visible'); }, 400);
  }
  ...
  function _0x24a92b26(c) {
    ...
    const _0xe4c1f460 = !!c.ytId, _0x1e7ed101 = !!c.featured;
    const _0xccd16c6c = (_0xe4c1f460 && !_0x1e7ed101) ? `onmouseenter="startPreview(this,'${c.ytId}')" onmouseleave="stopPreview(this)"` : '';
    return `<div class="_caf9e322f${_0x1e7ed101 ? ' featured' : ''}" data-id="${c.id}" data-ytid="${(c.ytId || '')}" onclick="openModal('${c.id}')" ${_0xccd16c6c}>
  ...
  function _0xd1019e06() { return (_0x84479b26.displayMode || 'all'); }
  function _0x7ceb9cc1() { return (parseInt(_0x84479b26.perPage) || 12); }

  function _0xacf50601(_0x6fd7d97f) {
    if (_0x6fd7d97f) { _0xd529bd4d = 1; _0xa0c7171f = 0; }
    const _0x14da41af = _0x8cbf6036("_cee573d3c"), _0xd977ad44 = _0xd1019e06(), perPage = _0x7ceb9cc1();
    ...
    ['mv-pagination', 'mv-loadmore-btn'].forEach(id => { const e = _0x8cbf6036(id); if (e) e.remove(); });
    ...
    if ((_0xd977ad44 === 'pagination')) {
      const _0x700496c2 = Math.ceil((_0xc84e4a0a.length / perPage)); _0xd529bd4d = Math.min(_0xd529bd4d, _0x700496c2);
      const slice = _0xc84e4a0a.slice(((_0xd529bd4d - 1) * perPage), (_0xd529bd4d * perPage));
      _0x14da41af.innerHTML = slice.map(_0x24a92b26).join('');
      if ((_0x700496c2 > 1)) {
        const bar = document.createElement('div'); bar.id = 'mv-pagination'; bar.style.cssText = 'grid-column:1/-1;display:flex;justify-content:center;gap:6px;padding:32px 0 8px;flex-wrap:wrap';
        for (let _0x226d1734 = 1; (_0x226d1734 <= _0x700496c2); _0x226d1734++) {
          const btn = document.createElement('button'); btn.textContent = _0x226d1734;
          ...
          btn.onclick = () => { _0xd529bd4d = _0x226d1734; _0xacf50601(false); window.scrollTo({ top: (_0x8cbf6036("_c94a87bcc").offsetTop - 80), behavior: 'smooth' }); };
          bar.appendChild(btn);
        }
      ...
      if ((_0xa0c7171f < _0xc84e4a0a.length)) {
        ...
        const btn = document.createElement('button'); btn.id = 'mv-loadmore-btn'; btn.textContent = `Load More (${rem} more)`;
        ...
        btn.onmouseenter = () => btn.style.background = 'rgba(200,255,0,.08)'; btn.onmouseleave = () => btn.style.background = 'transparent';
        btn.onclick = () => { _0xa0c7171f += perPage; _0xacf50601(false); };
        _0x14da41af.appendChild(btn);
      }
    } else { _0x14da41af.innerHTML = _0xc84e4a0a.map(_0x24a92b26).join(''); }
    requestAnimationFrame(() => _0xb9a49dc5());
  }

  function _0x78c09654() {
    const tags = new Set(); _0xa18d6424.forEach(c => (c.tags || []).forEach(t => tags.add(t)));
  ...
  function filterCards(tag, btn) {
    ...
    btn.classList.add("_c599f219d"); _0xacf50601(true);
  }

  function _0xb9a49dc5() {
    if (!_0xf0228b0a) return;
    document.querySelectorAll("._caf9e322f.featured").forEach(card => {
      const ytId = card.dataset.ytid; if (!ytId || card.classList.contains('previewing')) return;
      const _0xc3411b76 = _0xe2bda6ba.get(ytId);
      if (_0xc3411b76) {
        _0xc3411b76.removeAttribute('style'); _0xc3411b76.className = 'mv-preview-iframe';
        card.insertBefore(_0xc3411b76, card.firstChild); card.classList.add('previewing', 'featured-autoplay');
        if (_0xc3411b76.contentWindow) { if (_0xc3411b76._mvReady) card.classList.add('preview-ready'); else _0xc3411b76.onload = () => { _0xc3411b76._mvReady = true; card.classList.add('preview-ready'); }; }
        _0xe2bda6ba.delete(ytId);
      } else { _0x40614a84(card, ytId); }
    });
  }

  function _0x40614a84(card, ytId) {
    if (!_0xf0228b0a || card.classList.contains('previewing')) return;
    card.classList.add('previewing', 'featured-autoplay');
    const iframe = document.createElement('iframe'); iframe.className = 'mv-preview-iframe'; iframe.allow = 'autoplay';
    ...
    iframe.onload = () => { iframe._mvReady = true; card.classList.add('preview-ready'); };
  ...
  function _0x14f8e1ec() {
    ...
    if (!_0xa18d6424.length) {
      ...
      if (_0x9b7b3144) { _0x9b7b3144.destroy(); _0x9b7b3144 = null; } return;
    }
    _0xf1c816fb.innerHTML = _0xa18d6424.map(c => {
      const thumb = (c.thumb || (c.ytId ? _0xce9b6a50(c.ytId) : '')), fallback = c.ytId ? _0x4d6ca5f9(c.ytId) : '';
    ...
    if (_0x9b7b3144) { _0x9b7b3144.destroy(); _0x9b7b3144 = null; }
    _0x9b7b3144 = Sortable.create(_0xf1c816fb, {
      ...
      onEnd: async _0x0f9445d5 => {
        ...
        if (!_0xf5b67c4d) {
          _0xf5b67c4d = document.createElement('div'); _0xf5b67c4d.id = 'sort-saving';
        ...
        await Promise.all(_0xa18d6424.map((c, i) => _0xb6b66b5e.from('mv_works').update({ sort_order: i }).eq('id', c.id)));
        _0xf5b67c4d.remove(); _0xe90d247c('Order saved! ✓', 'success'); _0xacf50601(true);
      }
    });
  }
  ...
  function toggleEdit(id) {
    ...
    document.querySelectorAll('.inline-edit.open').forEach(p => { if ((p.id !== ('edit-' + id))) p.classList.remove('open'); });
  ...
  async function saveEdit(id) {
    const _0xeb5c7d7b = _0x8cbf6036(`e-url-${id}`).value.trim(), title = _0x8cbf6036(`e-title-${id}`).value.trim(), artist = _0x8cbf6036(`e-artist-${id}`).value.trim();
    const _0x4e25ca0a = _0x8cbf6036(`e-tags-${id}`).value.trim(), thumb = _0x8cbf6036(`e-thumb-${id}`).value.trim(), _0x72d413ae = _0x8cbf6036(`e-feat-${id}`).checked;
    if (!title) { _0xe90d247c('Title cannot be empty!', 'error'); return; }
    await _0xd9f6e27f();
    ...
    const { error } = await _0xb6b66b5e.from('mv_works').update({ ytId, title, artist, tags, thumb: (thumb || null), featured: _0x72d413ae }).eq('id', id);
    btn.textContent = '💾 Save Changes'; btn.disabled = false;
    if (error) { _0xe90d247c(('Error: ' + error.message), 'error'); return; }
    _0xe90d247c('Work updated! ✓', 'success'); toggleEdit(id);
  }
  ...
  async function addCard() {
    const _0x7b2b853d = _0x8cbf6036("_c0f818419").value.trim(), title = _0x8cbf6036("_cbea007de").value.trim(), artist = _0x8cbf6036("_c80317461").value.trim();
    const _0x87eeee05 = _0x8cbf6036("_cdab21455").value.trim(), thumb = _0x8cbf6036("_c102b8d76").value.trim(), feat = _0x8cbf6036("_c0e034389").checked;
    if (!title) { _0xe90d247c('Title is required!', 'error'); return; }
    await _0xd9f6e27f();
    const ytId = _0xd6005f09(_0x7b2b853d);
    const tags = _0x87eeee05 ? _0x87eeee05.split(',').map(t => t.trim()).filter(Boolean) : [];
    const btn = _0x8cbf6036("_c3627024f"); btn.disabled = true; btn.textContent = 'Saving...';
    const { error } = await _0xb6b66b5e.from('mv_works').insert([{ ytId, title, artist, tags, thumb: (thumb || null), featured: feat, sort_order: -1 }]);
  ...
  async function deleteCard(id) {
    ...
    await _0xd9f6e27f();
    const { error } = await _0xb6b66b5e.from('mv_works').delete().eq('id', id);
    if (error) { _0xe90d247c(('Error: ' + error.message), 'error'); return; }
  ...
  function openModal(id) {
    ...
    if (!c) return;
    _0x8cbf6036("_c83628aba").textContent = c.title; _0x8cbf6036("_cc80e23b8").textContent = (c.artist || '');
    ...
    _0x8cbf6036("_cf57f4f0c").classList.add('open'); document.body.style.overflow = 'hidden';
  }

  function closeModal(e) {
    if ((e && (e.target !== _0x8cbf6036("_cf57f4f0c")))) return;
    _0x8cbf6036("_cf57f4f0c").classList.remove('open');
    _0x8cbf6036("_cf4d18526").innerHTML = ''; document.body.style.overflow = '';
  }

  function onUrlInput(val) {
    clearTimeout(_0xfa1191eb);
    const ytId = _0xd6005f09(val);
    if (!ytId) { _0xc306a47f('', ''); return; }
  ...
  async function _0x6c1a5441(ytId) {
    ...
    } catch { _0xc306a47f('err', '⚠ Could not fetch info'); }
  }

  function _0xc306a47f(type, msg) {
    const s = _0x8cbf6036("_cae9a3bd3"); s.textContent = msg; s.className = ("_cae9a3bd3" + (type ? (' ' + type) : ''));
  }

  let _0x1a0ab46c = null;
  function toggleEditMode() {
    const _0xee5d866d = document.body.classList.toggle('edit-mode');
    const bar = _0x8cbf6036('edit-mode-bar'), btn = _0x8cbf6036('edit-mode-toggle-btn');
    if (_0xee5d866d) {
      bar.classList.add("_c599f219d");
      btn.textContent = '✦ Exit Drag Mode'; btn.style.background = 'rgba(255,60,172,.1)'; btn.style.borderColor = 'rgba(255,60,172,.4)'; btn.style.color = 'var(--accent2)';
      _0x8cbf6036("_c5f03bd80").classList.remove('open'); _0xec34ec2f();
    } else { exitEditMode(); }
  }
  ...
  function exitEditMode() {
    ...
    if (btn) { btn.textContent = '✦ Drag Reorder on Page'; btn.style.background = 'rgba(200,255,0,.1)'; btn.style.borderColor = 'rgba(200,255,0,.3)'; btn.style.color = 'var(--accent)'; }
    if (_0x1a0ab46c) { _0x1a0ab46c.destroy(); _0x1a0ab46c = null; }
  }

  function _0xec34ec2f() {
    const grid = _0x8cbf6036("_cee573d3c"); if (!grid) return;
    if (_0x1a0ab46c) _0x1a0ab46c.destroy();
    _0x1a0ab46c = Sortable.create(grid, {
      animation: 200, draggable: "._caf9e322f", ghostClass: 'sortable-ghost', chosenClass: 'sortable-chosen',
      onEnd: evt => {
  ...
  async function saveGridOrder() {
    ...
    await Promise.all(_0xa18d6424.map((c, i) => _0xb6b66b5e.from('mv_works').update({ sort_order: i }).eq('id', c.id)));
    _0xe90d247c('Order saved! ✓', 'success'); exitEditMode(); _0xacf50601(true);
  }

  let _0x4201bc80 = null, _0x000ead5c = null;
  ...
  function startPreview(card, ytId) {
    ...
    if (!_0x0646ae88.has(ytId)) {
      ...
      _0xe22a9dc7.allow = 'autoplay'; _0xe22a9dc7.style.cssText = 'position:fixed;width:1px;height:1px;opacity:0;pointer-events:none;top:-9999px;left:-9999px;border:none;';
      document.body.appendChild(_0xe22a9dc7); _0x0646ae88.set(ytId, _0xe22a9dc7);
    }
    _0x4201bc80 = setTimeout(() => {
      stopPreview(_0x000ead5c); _0x000ead5c = card; card.classList.add('previewing');
      const _0xf5118222 = _0x0646ae88.get(ytId);
      if (_0xf5118222) {
        _0xf5118222.removeAttribute('style'); _0xf5118222.className = 'mv-preview-iframe';
        ...
        card.insertBefore(_0xf5118222, card.firstChild); _0xf5118222.onload = () => card.classList.add('preview-ready');
      }
    }, 700);
  }
  ...
  function stopPreview(card) {
    ...
    if (!card || card.classList.contains('featured-autoplay')) return;
  ...
  function previewColor(_0xd42c35b6, val) { document.documentElement.style.setProperty(('--' + _0xd42c35b6), val); const hex = _0x8cbf6036((('color-' + _0xd42c35b6) + '-hex')); if (hex) hex.value = val; }
  function previewColorHex(varName, _0xcb2ec118) {
    const val = _0xcb2ec118.value.trim();
    if (/^#[0-9a-fA-F]{6}$/.test(val)) { document.documentElement.style.setProperty(('--' + varName), val); const _0xb10d435b = _0x8cbf6036(('color-' + varName)); if (_0xb10d435b) _0xb10d435b.value = val; }
  }

  async function saveColors() {
    await _0xd9f6e27f();
    const colors = {
      text: (_0x8cbf6036('color-text')?.value || '#f0f0f0'), accent: _0x8cbf6036('color-accent').value,
      accent2: _0x8cbf6036('color-accent2').value, bg: _0x8cbf6036('color-bg').value, surface: _0x8cbf6036('color-surface').value
    };
    _0x84479b26.colors = colors;
    const btn = _0x8cbf6036('color-save-btn'); btn.textContent = 'Saving...'; btn.disabled = true;
    try {
      const { error } = await _0xb6b66b5e.from('mv_site').upsert({ id: 1, data: _0x84479b26 });
      if (error) throw error; _0xe90d247c('Colors saved! ✓', 'success');
    } catch (err) { _0xe90d247c(('Error: ' + err.message), 'error'); } finally { btn.textContent = '💾 Save Colors'; btn.disabled = false; }
  }

  function _0x91674fd5(colors) {
    if (!colors) return;
    Object.entries(colors).forEach(([k, v]) => { document.documentElement.style.setProperty(('--' + k), v); const inp = _0x8cbf6036(('color-' + k)); if (inp) inp.value = v; const hex = _0x8cbf6036((('color-' + k) + '-hex')); if (hex) hex.value = v; });
  }

  function resetColors() {
    const _0x9f251b7d = { text: '#f0f0f0', accent: '#c8ff00', accent2: '#ff3cac', bg: '#080810', surface: '#10101c' };
    _0x91674fd5(_0x9f251b7d); _0x84479b26.colors = _0x9f251b7d; _0xe90d247c('Reset to default — click Save Colors to keep it', '');
  }

  function _0x15a4ac37() {
    if (_0x84479b26.colors) _0x91674fd5(_0x84479b26.colors);
    if (_0x84479b26.logoData) { const _0xe9d59cc5 = _0x8cbf6036("_c31fff579"); const img = _0x8cbf6036("_c0fb6ef60"); if ((_0xe9d59cc5 && img)) { img.src = _0x84479b26.logoData; _0xe9d59cc5.style.display = 'block'; } }
  }

  let _0x968f10d5 = null, _0xbc0f0785 = null;
  ...
  function _0x45b4c249(file) { return (file.name.split('.').pop().toLowerCase() || 'png'); }
  async function _0x4345011a(file, _0xa96f575e) {
    if (!file) return null;
    const _0x5482b17c = _0xdbc607e1(file), ext = _0x45b4c249(file);
    const _0xcbe9baa1 = `${_0xa96f575e}/${Date.now()}-${Math.random().toString(36).substring(7)}.${ext}`;
    const { data, error } = await _0xb6b66b5e.storage.from('portfolio-assets').upload(_0xcbe9baa1, file, { upsert: true, contentType: _0x5482b17c });
    if (error) { console.error('Upload Error:', error); throw error; }
    const { data: _0x673b9c8a } = _0xb6b66b5e.storage.from('portfolio-assets').getPublicUrl(_0xcbe9baa1); return _0x673b9c8a.publicUrl;
  }

  function handleLogoUpload(input) {
    const file = input.files[0]; if (!file) return; _0x968f10d5 = file;
    const _0x1e0bcb65 = URL.createObjectURL(file), prev = _0x8cbf6036("_c31fff579"), img = _0x8cbf6036("_c0fb6ef60");
    if ((prev && img)) { img.src = _0x1e0bcb65; prev.style.display = 'block'; }
    _0xe90d247c('Logo selected — click Save Logo & Favicon', '');
  }

  function handleFaviconUpload(input) { const file = input.files[0]; if (!file) return; _0xbc0f0785 = file; _0xe90d247c('Favicon selected — click Save Logo & Favicon', ''); }

  async function saveLogoFavicon() {
    await _0xd9f6e27f();
    if ((!_0x968f10d5 && !_0xbc0f0785)) { _0xe90d247c('Silakan pilih gambar (Klik Choose File) terlebih dahulu', 'error'); return; }
    const btn = _0x8cbf6036("_c77146998"); btn.textContent = 'Uploading & Saving...'; btn.disabled = true;
    try {
      if (_0x968f10d5) { const _0xbf8a4b8c = await _0x4345011a(_0x968f10d5, 'logos'); if (_0xbf8a4b8c) _0x84479b26.logoData = _0xbf8a4b8c; }
      if (_0xbc0f0785) { const _0x034a0345 = await _0x4345011a(_0xbc0f0785, 'favicons'); if (_0x034a0345) _0x84479b26.faviconData = _0x034a0345; }
      const { error } = await _0xb6b66b5e.from('mv_site').upsert({ id: 1, data: _0x84479b26 });
      if (error) throw error;
      _0x04244f71(); _0x8cbf6036("_c8e416775").value = ''; _0x8cbf6036("_cb430d114").value = ''; _0x968f10d5 = null; _0xbc0f0785 = null;
      _0xe90d247c('Logo & Favicon uploaded and saved! ✓', 'success');
    } catch (err) { console.error(err); _0xe90d247c(('Error: ' + err.message), 'error'); } finally { btn.textContent = '💾 Save Logo & Favicon'; btn.disabled = false; }
  }

  function _0x04244f71() {
    const _0x32a6ac6b = document.getElementById("_cb7951de5"), _0x326a4209 = document.getElementById("_c10ef4112");
    if (_0x84479b26.logoData) {
      if (_0x326a4209) _0x326a4209.style.display = 'none';
      if (_0x32a6ac6b) { _0x32a6ac6b.style.display = 'block'; _0x32a6ac6b.src = _0x84479b26.logoData; }
      try { localStorage.setItem('mv_logo_url', _0x84479b26.logoData); } catch (e) {}
    } else {
    ...
    if (_0x84479b26.faviconData) {
      ...
      if (!_0xea7d7dd4) { _0xea7d7dd4 = document.createElement('link'); _0xea7d7dd4.rel = 'icon'; document.head.appendChild(_0xea7d7dd4); }
  ...
  async function deleteLogo() {
    ...
    if (error) { _0xe90d247c(('Error: ' + error.message), 'error'); return; }
    _0x04244f71();
    const prev = _0x8cbf6036("_c31fff579"), img = _0x8cbf6036("_c0fb6ef60");
    if (prev) prev.style.display = 'none'; if (img) img.src = '';
    _0xe90d247c('Logo dihapus! ✓', 'success');
  }

  function _0x82d5aeb5() {
    const s = _0x84479b26; if ((!s || !Object.keys(s).length)) return;
    if (s.colors) _0x91674fd5(s.colors); _0x04244f71();
    const _0xcf00b94e = ((s.siteTitle || s.brand) || 'MV Portfolio'); document.title = _0xcf00b94e;
    ...
    _0x343b389d("_cccb35ac0", s.label); _0x343b389d("_ca52a766b", s.hsub); _0x343b389d("_c91bea30c", s.about1); _0x343b389d("_c88d17da1", s.about2); _0x343b389d("_c3dfb8158", s.copy);
    ...
    const _0xbb5cf64c = [{ key: 'yt', label: 'YouTube', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2C0 8.1 0 12 0 12s0 3.9.5 5.8a3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1C24 15.9 24 12 24 12s0-3.9-.5-5.8zM9.7 15.5V8.5l6.3 3.5-6.3 3.5z"/></svg>', primary: true }, { key: 'tw', label: 'Twitter/X', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>', primary: false }, { key: 'discord', label: 'Discord', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057c.003.024.015.046.033.06a19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg>', primary: false }, { key: 'vgen', label: 'VGen', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>', primary: false }, { key: 'ig', label: 'Instagram', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>', primary: false }, { key: 'tiktok', label: 'TikTok', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>', primary: false }];
    const _0x8f5ff421 = _0x8cbf6036("_cb3a13754"), _0xecfe0db1 = _0x8cbf6036("_c1c7ba293");
  ...
  function _0xfafd1919() {
    ...
    const mode = (s.displayMode || 'all'), _0x09f1b2ef = _0x8cbf6036(('dm-' + mode));
    if (_0x09f1b2ef) _0x09f1b2ef.checked = true;
  }

  function previewMode(mode) { _0x84479b26.displayMode = mode; _0xacf50601(true); }

  async function saveSiteEdit() {
    const mode = document.querySelector('input[name="display-mode"]:checked');
    _0x84479b26 = {
      brand: _0x8cbf6036('s-brand').value, siteTitle: _0x8cbf6036('s-siteTitle').value, label: _0x8cbf6036('s-label').value,
      htitle: _0x8cbf6036('s-htitle').value, hsub: _0x8cbf6036('s-hsub').value, about1: _0x8cbf6036('s-about1').value,
      about2: _0x8cbf6036('s-about2').value, yt: _0x8cbf6036('s-yt').value, tw: _0x8cbf6036('s-tw').value,
      discord: _0x8cbf6036('s-discord').value, vgen: _0x8cbf6036('s-vgen').value, ig: _0x8cbf6036('s-ig').value,
      tiktok: _0x8cbf6036('s-tiktok').value, copy: _0x8cbf6036('s-copy').value, year: _0x8cbf6036('s-year').value,
      displayMode: mode ? mode.value : 'all', perPage: (parseInt(_0x8cbf6036('s-perpage')?.value) || 12),
      colors: _0x84479b26.colors, logoData: _0x84479b26.logoData, faviconData: _0x84479b26.faviconData
    };
    const btn = _0x8cbf6036("_c03543076"); btn.textContent = 'Saving...'; btn.disabled = true;
    await _0xd9f6e27f();
    try {
      const { error } = await _0xb6b66b5e.from('mv_site').upsert({ id: 1, data: _0x84479b26 });
      if (error) throw error;
      _0x82d5aeb5(); _0x1a38ce4d(); _0xacf50601(true); _0xe90d247c('Site info saved! ✓', 'success');
    } catch (err) { _0xe90d247c(('Error: ' + err.message), 'error'); } finally { btn.textContent = 'Simpan Info Site →'; btn.disabled = false; }
  }

  function _0xf7ab76f4() {
    const _0x72680117 = _0x8cbf6036('site-edit-panel'); if (_0x72680117) _0x72680117.classList.remove('open');
  }

  // --- MENGEKSPOS FUNGSI AMAN KE WINDOW ---
  // Agar tombol-tombol di HTML tidak error
  ...
  window.saveGridOrder = saveGridOrder;
  ...
  window.saveLogoFavicon = saveLogoFavicon;
  window.deleteLogo = deleteLogo;
  window.previewColor = previewColor;
  window.previewColorHex = previewColorHex;
  window.saveColors = saveColors;
  window.resetColors = resetColors;
  window.syncPresetHighlight = syncPresetHighlight;
  window.toggleEdit = toggleEdit;
  window.saveEdit = saveEdit;
  window.closeAdminPanel = closeAdminPanel;

  // --- MENGIKAT EVENT UNTUK TOMBOL LOGIN DENGAN AMAN ---
  document.addEventListener('DOMContentLoaded', () => {
    const emailInput = _0x8cbf6036("_c5daa9f69");
    const pwInput = _0x8cbf6036("_c5e9ad1ef");
    const signInBtn = _0x8cbf6036("_c9bf2f222");
    ...
    if (signInBtn) {
        signInBtn.addEventListener('click', checkPw);
    }
  });

  async function _0xba5db47e() {
    const _0xfc1b0867 = _0x8cbf6036("_c8e416775"), _0x0a53e498 = _0x8cbf6036("_cb430d114");
    if (_0xfc1b0867) _0xfc1b0867.value = ''; if (_0x0a53e498) _0x0a53e498.value = '';
    document.body.classList.add('loading');
    _0x65b812cd(15, 'Connecting...');
    _0xb6b66b5e = window.supabase.createClient(_0x0bc43252, _0x56e8bdfe);
    _0x65b812cd(35, 'Loading site info...'); await _0x613ca34b();
    _0x65b812cd(60, 'Loading works...'); await _0x71ef0847();
    _0x65b812cd(75, 'Preloading previews...'); await _0x54637bbb();
    _0x65b812cd(90, 'Almost there...');
    _0xb6b66b5e.channel('mv_realtime').on('postgres_changes', { event: '*', schema: 'public', table: 'mv_works' }, _0x71ef0847).on('postgres_changes', { event: '*', schema: 'public', table: 'mv_site' }, _0x613ca34b).subscribe();
    ...
    setTimeout(() => {
      ...
      setTimeout(async () => {
        ...
        // Cek login saat pertama kali render (pengganti `_0xc926f275()`)
        const { data: { session } } = await _0xb6b66b5e.auth.getSession();
        if (session) _0x8cbf6036("_c5f03bd80").classList.add('open');
      }, 300);
    }, 200);
  }
